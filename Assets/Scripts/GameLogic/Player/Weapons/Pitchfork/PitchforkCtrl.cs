...
namespace GameLogic.Player.Weapons.Pitchfork
{
    public class PitchforkCtrl : WeaponCtrlBase
    {
        ...
        private static readonly int AttackAnim = Animator.StringToHash("PitchforkAttackAnim");
